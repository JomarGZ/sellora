...
const HeroSection = () => (
  <div className="relative hidden h-full min-h-screen flex-col justify-between overflow-hidden lg:flex">
    ...
    />
    <div className="absolute inset-0 bg-gradient-to-t from-[hsl(var(--login-hero-overlay)/0.85)] via-[hsl(var(--login-hero-overlay)/0.4)] to-[hsl(var(--login-hero-overlay)/0.2)]" />
